 ...
 * Define os paises e suas descricoes conforme tabela da receita:
...
public enum DFPais {
    ...
    COREIA_DO_NORTE_REP_POP_DEMOCRATICA(1872, "COREIA (DO NORTE), REP.POP.DEMOCRATICA", LocalDate.of(2006,1,1)),
    COREIA_DO_SUL_REPUBLICA_DA(1902, "COREIA (DO SUL), REPUBLICA DA", LocalDate.of(2006,1,1)),

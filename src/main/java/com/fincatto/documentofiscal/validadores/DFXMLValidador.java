...
public final class DFXMLValidador {
    ...
    private static boolean valida(final String xml, final String xsd) throws IOException, SAXException, URISyntaxException {
        ...
        final SchemaFactory schemaFactory = SchemaFactory.newInstance(URL_XML_SCHEMA);
    ...
    public static boolean validaLoteCTe(final String arquivoXML) throws SAXException {
        try {
            return DFXMLValidador.validaCTe(arquivoXML, "enviCTe_v3.00.xsd");
        } catch (SAXException | IOException | URISyntaxException e) {
            throw new SAXException(XML_VALIDATION_FAIL_MESSAGE, e);
        }
    }

    public static boolean validaNotaCte(final String arquivoXML) throws SAXException {
        try {

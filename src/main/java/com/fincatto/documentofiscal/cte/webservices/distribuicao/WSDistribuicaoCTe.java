...
public class WSDistribuicaoCTe {
    ...
    public static String consultar(final CTDistribuicaoInt distDFeInt, final NFeConfig config) throws RemoteException, XMLStreamException, NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
        ...
        final CTeDistribuicaoDFeSoapStub.CteDadosMsgType0 dadosMsgType0 = new CTeDistribuicaoDFeSoapStub.CteDadosMsgType0();
    ...
    public NFDistribuicaoIntRetorno consultar(final String cpfOuCnpj, final DFUnidadeFederativa uf, final String nsu, final String ultNsu) throws Exception {
        try {
            ...
            throw new org.apache.axis2.databinding.ADBException("Error parsing XML", e);
        }
    }

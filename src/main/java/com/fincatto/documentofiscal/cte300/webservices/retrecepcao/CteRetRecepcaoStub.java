...
public class CteRetRecepcaoStub extends org.apache.axis2.client.Stub {
    ...
    public com.fincatto.documentofiscal.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteRetRecepcaoResult cteRetRecepcao(final com.fincatto.documentofiscal.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteDadosMsg cteDadosMsg0, final com.fincatto.documentofiscal.cte300.webservices.retrecepcao.CteRetRecepcaoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            env = this.toEnvelope(Stub.getFactory(operationClient.getOptions().getSoapVersionURI()), cteDadosMsg0, this.optimizeContent(new javax.xml.namespace.QName(WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RET_RECEPCAO, CTE_RET_RECEPCAO)), new javax.xml.namespace.QName(WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RET_RECEPCAO, CTE_RET_RECEPCAO));
            env.build();
            // add the children only if the parameter is not null
            if (cteCabecMsg1 != null) {
                final org.apache.axiom.om.OMElement omElementcteCabecMsg1 = this.toOM(cteCabecMsg1, this.optimizeContent(new javax.xml.namespace.QName(WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RET_RECEPCAO, CTE_RET_RECEPCAO)));

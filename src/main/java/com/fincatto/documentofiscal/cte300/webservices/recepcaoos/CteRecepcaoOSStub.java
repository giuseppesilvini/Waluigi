...
public class CteRecepcaoOSStub extends org.apache.axis2.client.Stub {
    ...
    private void populateAxisService() {
        ...
        operation.setName(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_OS, CTE_RECEPCAO_OS));
    ...
    public com.fincatto.documentofiscal.cte300.webservices.recepcaoos.CteRecepcaoOSStub.CteRecepcaoOSResult cteRecepcaoOS(final com.fincatto.documentofiscal.cte300.webservices.recepcaoos.CteRecepcaoOSStub.CteDadosMsg cteDadosMsg0, final com.fincatto.documentofiscal.cte300.webservices.recepcaoos.CteRecepcaoOSStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            if (!this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), CTE_RECEPCAO_OS))) {
                throw f;
            }
            // make the fault by reflection
            try {
                final java.lang.String exceptionClassName = (java.lang.String) this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), CTE_RECEPCAO_OS));
                ...
                // message class
                final java.lang.String messageClassName = (java.lang.String) this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), CTE_RECEPCAO_OS));
    ...
    public static class CteCabecMsg implements org.apache.axis2.databinding.ADBBean {
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
            ...
            if (this.localVersaoDadosTracker) {
                elementList.add(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_OS, VERSAO_DADOS));
                if (this.localVersaoDados != null) {
        ...
        public static class Factory {
            ...
            private static CteCabecMsg parsePart3(CteCabecMsg object, javax.xml.stream.XMLStreamReader reader) throws XMLStreamException {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_OS, VERSAO_DADOS).equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue(XMLSCHEMA_INSTANCE, "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
        ...
        public static class Factory {
            ...
            public static CteRecepcaoOSResult parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
                ...
                try {
                    ...
                    CteRecepcaoOSResult varParse = parsePart1(reader);
                    if(varParse != null) {
                        return varParse;
                    }
                    // Note all attributes that were handled. Used to differ normal attributes

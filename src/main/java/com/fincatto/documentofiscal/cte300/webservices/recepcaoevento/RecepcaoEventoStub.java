...
public class RecepcaoEventoStub extends org.apache.axis2.client.Stub {
    ...
    private static final String CTE_RECEPCAO_EVENTO = "cteRecepcaoEvento";
    ...
    public static final String HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO = "http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento";
    ...
    private void populateAxisService() {
        ...
        operation.setName(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO, CTE_RECEPCAO_EVENTO));
    ...
    public com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult cteRecepcaoEvento(final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg cteDadosMsg0, final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento/cteRecepcaoEvento");
            ...
            final java.lang.Object object = this.fromOM(returnEnv.getBody().getFirstElement(), com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult.class);
            ...
            if (!this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), CTE_RECEPCAO_EVENTO))) {
                throw f;
            }
            // make the fault by reflection
            try {
                final java.lang.String exceptionClassName = (java.lang.String) this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), CTE_RECEPCAO_EVENTO));
                ...
                // message class
                final java.lang.String messageClassName = (java.lang.String) this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), CTE_RECEPCAO_EVENTO));
    ...
    private org.apache.axis2.client.async.AxisCallback createCallback(com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoCallbackHandler callback, org.apache.axis2.context.MessageContext messageContext) {
        return new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = RecepcaoEventoStub.this.fromOM(resultEnv.getBody().getFirstElement(), com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult.class);
    ...
    private void callbackError(java.lang.Exception error, com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoCallbackHandler callback) {
        if (error instanceof org.apache.axis2.AxisFault) {
            final org.apache.axis2.AxisFault f = (org.apache.axis2.AxisFault) error;
            final org.apache.axiom.om.OMElement faultElt = f.getDetail();
            if (faultElt != null &&
                        RecepcaoEventoStub.this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), CTE_RECEPCAO_EVENTO))) {
                // make the fault by reflection
                try {
                    final java.lang.String exceptionClassName = (java.lang.String) RecepcaoEventoStub.this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), CTE_RECEPCAO_EVENTO));
                    final java.lang.Class exceptionClass = java.lang.Class.forName(exceptionClassName);
                    final java.lang.reflect.Constructor constructor = exceptionClass.getConstructor(String.class);
                    final java.lang.Exception ex = (java.lang.Exception) constructor.newInstance(f.getMessage());
                    // message class
                    final java.lang.String messageClassName = (java.lang.String) RecepcaoEventoStub.this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), CTE_RECEPCAO_EVENTO));
                    final java.lang.Class messageClass = java.lang.Class.forName(messageClassName);
                    final java.lang.Object messageObject = RecepcaoEventoStub.this.fromOM(faultElt, messageClass);
                    final java.lang.reflect.Method m = exceptionClass.getMethod("setFaultMessage", messageClass);
                    m.invoke(ex, messageObject);
    ...
    public static class CteCabecMsgE implements org.apache.axis2.databinding.ADBBean {
        ...
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO, CTE_CABEC_MSG, "");
        ...
        private static java.lang.String generatePrefix(final java.lang.String namespace) {
            if (namespace.equals(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO)) {
                return "";
            }
                ...
                try {
                    ...
                    while (!reader.isEndElement()) {
                        if (reader.isStartElement()) {
                            if (reader.isStartElement() && new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO, CTE_CABEC_MSG).equals(reader.getName())) {
    ...
    public static class CteRecepcaoEventoResult implements org.apache.axis2.databinding.ADBBean {
        ...
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO, RECEPCAO_EVENTO_RESULT, "");
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (serializeType) {
                final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO);
                if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                    this.writeAttribute("xsi", XMLSCHEMA_INSTANCE, "type", namespacePrefix + ":cteRecepcaoEventoResult", xmlWriter);
                } else {
                    this.writeAttribute("xsi", XMLSCHEMA_INSTANCE, "type", RECEPCAO_EVENTO_RESULT, xmlWriter);
                }
            }
        ...
        public static class Factory {
            ...
            public static CteRecepcaoEventoResult parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
                ...
                try {
                    ...
                    CteRecepcaoEventoResult varParse = parsePart1(reader);
                    if(varParse != null) {
                        return varParse;
                    }
                    // Note all attributes that were handled. Used to differ normal attributes
            ...
            static private CteRecepcaoEventoResult parsePart1(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
    ...
    public static class CteCabecMsg implements org.apache.axis2.databinding.ADBBean {
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (this.localCUFTracker) {
                namespace = HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO;
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
            ...
            final java.util.ArrayList attribList = new java.util.ArrayList();
            if (this.localCUFTracker) {
                elementList.add(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO, "cUF"));
                if (this.localCUF != null) {
            ...
            if (this.localVersaoDadosTracker) {
                elementList.add(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO, VERSAO_DADOS));
                if (this.localVersaoDados != null) {
        ...
        public static class Factory {
            ...
            private static CteCabecMsg parsePart2 (CteCabecMsg object, javax.xml.stream.XMLStreamReader reader) throws XMLStreamException {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO, "cUF").equals(reader.getName())) {
            ...
            private static CteCabecMsg parsePart3 (CteCabecMsg object, javax.xml.stream.XMLStreamReader reader) throws XMLStreamException {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO, VERSAO_DADOS).equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue(XMLSCHEMA_INSTANCE, "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
    ...
    public static class ExtensionMapper {
        ...
        public static java.lang.Object getTypeObject(final java.lang.String namespaceURI, final java.lang.String typeName, final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            if (HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO.equals(namespaceURI) && CTE_CABEC_MSG.equals(typeName)) {
    ...
    public static class CteDadosMsg implements org.apache.axis2.databinding.ADBBean {
        ...
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_RECEPCAO_EVENTO, CTE_DADOS_MSG, "");
    ...
    private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg param) {
    ...
    private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteRecepcaoEventoResult param) {
    ...
    private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteCabecMsgE param) {
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final com.fincatto.documentofiscal.cte300.webservices.recepcaoevento.RecepcaoEventoStub.CteDadosMsg param) {

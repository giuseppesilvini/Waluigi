...
public class CteStatusServicoStub extends org.apache.axis2.client.Stub {
    ...
    public com.fincatto.documentofiscal.cte300.webservices.statusservico.CteStatusServicoStub.CteStatusServicoCTResult cteStatusServicoCT(final com.fincatto.documentofiscal.cte300.webservices.statusservico.CteStatusServicoStub.CteDadosMsg cteDadosMsg0, final com.fincatto.documentofiscal.cte300.webservices.statusservico.CteStatusServicoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            env = this.toEnvelope(Stub.getFactory(_operationClient.getOptions().getSoapVersionURI()), cteDadosMsg0, this.optimizeContent(new javax.xml.namespace.QName(WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_STATUS_SERVICO, CTE_STATUS_SERVICO_CT)), new javax.xml.namespace.QName(WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_STATUS_SERVICO, CTE_STATUS_SERVICO_CT));
            env.build();
            // add the children only if the parameter is not null
            if (cteCabecMsg1 != null) {
                final org.apache.axiom.om.OMElement omElementcteCabecMsg1 = this.toOM(cteCabecMsg1, this.optimizeContent(new javax.xml.namespace.QName(WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_STATUS_SERVICO, CTE_STATUS_SERVICO_CT)));
    ...
    public void startcteStatusServicoCT(final com.fincatto.documentofiscal.cte300.webservices.statusservico.CteStatusServicoStub.CteDadosMsg cteDadosMsg0, final com.fincatto.documentofiscal.cte300.webservices.statusservico.CteStatusServicoStub.CteCabecMsgE cteCabecMsg1, final com.fincatto.documentofiscal.cte300.webservices.statusservico.CteStatusServicoCallbackHandler callback) throws java.rmi.RemoteException {
        ...
        // Style is Doc.
        env = this.toEnvelope(Stub.getFactory(operationClient.getOptions().getSoapVersionURI()), cteDadosMsg0, this.optimizeContent(new javax.xml.namespace.QName(WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_STATUS_SERVICO, CTE_STATUS_SERVICO_CT)), new javax.xml.namespace.QName(WWW_PORTALFISCAL_INF_BR_CTE_WSDL_CTE_STATUS_SERVICO, CTE_STATUS_SERVICO_CT));
        ...
        operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onError(final java.lang.Exception error) {
                if (error instanceof org.apache.axis2.AxisFault) {
                    ...
                    final org.apache.axiom.om.OMElement faultElt = f.getDetail();
                    if (faultElt != null) {
                        if (CteStatusServicoStub.this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), CTE_STATUS_SERVICO_CT))) {
                            // make the fault by reflection
                            try {

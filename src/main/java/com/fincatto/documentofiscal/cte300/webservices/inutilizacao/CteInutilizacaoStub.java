...
public class CteInutilizacaoStub extends org.apache.axis2.client.Stub {
        ...
        org.apache.axis2.client.async.AxisCallback returnCallback = new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onError(final java.lang.Exception error) {
                if (error instanceof org.apache.axis2.AxisFault) {
                    ...
                    final org.apache.axiom.om.OMElement faultElt = f.getDetail();
                    if (faultElt != null &&
                                CteInutilizacaoStub.this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "cteInutilizacaoCT"))) {
                        // make the fault by reflection
                        try {
    ...
    public static class CteInutilizacaoCTResult implements org.apache.axis2.databinding.ADBBean {
        ...
        public static class Factory {
            ...
            static private CteInutilizacaoCTResult parsePart1(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
                if (reader.getAttributeValue(XMLSCHEMA_INSTANCE, "type") != null) {
                    final java.lang.String fullTypeName = reader.getAttributeValue(XMLSCHEMA_INSTANCE, "type");
                    if (fullTypeName != null) {
                        java.lang.String nsPrefix = null;
    ...
    private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.cte300.webservices.inutilizacao.CteInutilizacaoStub.CteDadosMsg param) {
    ...
    private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.cte300.webservices.inutilizacao.CteInutilizacaoStub.CteInutilizacaoCTResult param) {

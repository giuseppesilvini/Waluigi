...
public class NfeAutorizacaoStub extends org.apache.axis2.client.Stub {
    ...
    private static final String NFE_DADOS_MSG_ZIP = "nfeDadosMsgZip";
    ...
    public static class NfeAutorizacaoLoteZipResult implements org.apache.axis2.databinding.ADBBean {
        ...
        public static class Factory {
            ...
            private static NfeAutorizacaoLoteZipResult fullTypeNameNotNull(String fullTypeName, javax.xml.stream.XMLStreamReader reader) throws Exception {
    ...
    public static class NfeCabecMsgE implements org.apache.axis2.databinding.ADBBean {
        ...
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_AUTORIZACAO, NFE_CABEC_MSG, "");
            ...
            public static NfeCabecMsgE parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
                ...
                try {
                    ...
                    while (!reader.isEndElement()) {
                        if (reader.isStartElement()) {
                            if (reader.isStartElement() && new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_AUTORIZACAO, NFE_CABEC_MSG).equals(reader.getName())) {
    ...
    public static class NfeAutorizacaoLoteResult implements org.apache.axis2.databinding.ADBBean {
        ...
        public static class Factory {
            ...
            private static NfeAutorizacaoLoteResult fullTypeNameNotNull(String fullTypeName, javax.xml.stream.XMLStreamReader reader) throws Exception {
                if (fullTypeName != null) {
                    String nsPrefix = getNsPrefix(fullTypeName);
                    final java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":") + 1);
    ...
    public static class ExtensionMapper {
        ...
        public static java.lang.Object getTypeObject(final java.lang.String namespaceURI, final java.lang.String typeName, final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            if (HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_AUTORIZACAO.equals(namespaceURI) && NFE_CABEC_MSG.equals(typeName)) {
    ...
    public static class NfeDadosMsgZip implements org.apache.axis2.databinding.ADBBean {
        ...
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_AUTORIZACAO, NFE_DADOS_MSG_ZIP, "");
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (serializeType) {
                ...
                if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                    ...
                    this.writeAttribute("xsi", XMLSCHEMA_INSTANCE, "type", NFE_DADOS_MSG_ZIP, xmlWriter);
                }
            }
           ...
           private Factory() {
            ...
            public static NfeDadosMsgZip parse(final javax.xml.stream.XMLStreamReader reader) throws org.apache.axis2.databinding.ADBException {
                ...
                try {
                    ...
                    while (!reader.isEndElement()) {
                        if (reader.isStartElement()) {
                            if (reader.isStartElement() && new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_AUTORIZACAO, NFE_DADOS_MSG_ZIP).equals(reader.getName())) {
                                nillableValue = reader.getAttributeValue(XMLSCHEMA_INSTANCE, "nil");
                                if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
                                    throw new org.apache.axis2.databinding.ADBException(THE_ELEMENT + NFE_DADOS_MSG_ZIP + CANNOT_BE_NULL);
                                }
                                final java.lang.String content = reader.getElementText();

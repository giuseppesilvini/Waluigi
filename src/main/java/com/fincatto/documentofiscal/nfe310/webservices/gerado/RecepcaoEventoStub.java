...
public class RecepcaoEventoStub extends org.apache.axis2.client.Stub {
    ...
    public static final String HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_RECEPCAO_EVENTO = "http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento";
    public static final String NFE_RECEPCAO_EVENTO = "nfeRecepcaoEvento";
    ...
    private void populateAxisService() {
        ...
        operation.setName(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_RECEPCAO_EVENTO, NFE_RECEPCAO_EVENTO));
    ...
    public RecepcaoEventoStub.NfeRecepcaoEventoResult nfeRecepcaoEvento(final RecepcaoEventoStub.NfeDadosMsg nfeDadosMsg, final RecepcaoEventoStub.NfeCabecMsgE nfeCabecMsg) throws java.rmi.RemoteException {
        ...
        try {
            ...
            operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/nfe/wsdl/RecepcaoEvento/nfeRecepcaoEvento");
            ...
            final java.lang.Object object = this.fromOM(returnEnv.getBody().getFirstElement(), RecepcaoEventoStub.NfeRecepcaoEventoResult.class);
            return (RecepcaoEventoStub.NfeRecepcaoEventoResult) object;
        } catch (final org.apache.axis2.AxisFault f) {
            final org.apache.axiom.om.OMElement faultElt = f.getDetail();
            if (faultElt != null) {
                if (this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), NFE_RECEPCAO_EVENTO))) {
                    // make the fault by reflection
                    try {
                        final java.lang.String exceptionClassName = (java.lang.String) this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), NFE_RECEPCAO_EVENTO));
                        ...
                        // message class
                        final java.lang.String messageClassName = (java.lang.String) this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), NFE_RECEPCAO_EVENTO));
    ...
    public static class NfeDadosMsg implements org.apache.axis2.databinding.ADBBean {
        ...
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_RECEPCAO_EVENTO, NFE_DADOS_MSG, "");
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (serializeType) {
                final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_RECEPCAO_EVENTO);
        ...
        private static java.lang.String generatePrefix(final java.lang.String namespace) {
            if (namespace.equals(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_RECEPCAO_EVENTO)) {
                return "";
            }
    ...
    public static class NfeRecepcaoEventoResult implements org.apache.axis2.databinding.ADBBean {
        ...
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_RECEPCAO_EVENTO, NFE_RECEPCAO_EVENTO_RESULT, "");
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (serializeType) {
                final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_RECEPCAO_EVENTO);
                if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                    this.writeAttribute("xsi", XMLSCHEMA_INSTANCE, "type", namespacePrefix + ":nfeRecepcaoEventoResult", xmlWriter);
                } else {
                    this.writeAttribute("xsi", XMLSCHEMA_INSTANCE, "type", NFE_RECEPCAO_EVENTO_RESULT, xmlWriter);
                }
            }
            if (this.localExtraElement != null) {
                this.localExtraElement.serialize(xmlWriter);
        ...
        public static class Factory {
            ...
            private static NfeRecepcaoEventoResult fullTypeNameNotNull(String fullTypeName, javax.xml.stream.XMLStreamReader reader) throws Exception {
                if (fullTypeName != null) {
                    String nsPrefix = getNsPrefix(fullTypeName);
                    final java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":") + 1);
                    if (!NFE_RECEPCAO_EVENTO_RESULT.equals(type)) {
                        // find namespace for the prefix
                        final java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
    ...
    public static class NfeCabecMsg implements org.apache.axis2.databinding.ADBBean {
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (this.localCUFTracker) {
                namespace = HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_RECEPCAO_EVENTO;
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
            ...
            if (this.localCUFTracker) {
                elementList.add(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_RECEPCAO_EVENTO, "cUF"));
                if (this.localCUF != null) {
            ...
            if (this.localVersaoDadosTracker) {
                elementList.add(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_RECEPCAO_EVENTO, VERSAO_DADOS));
                if (this.localVersaoDados != null) {
        ...
        public static class Factory {
            ...
            private static NfeCabecMsg parsePart2 (NfeCabecMsg object, javax.xml.stream.XMLStreamReader reader) throws XMLStreamException {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_RECEPCAO_EVENTO, "cUF").equals(reader.getName())) {
            ...
            private static NfeCabecMsg parsePart3(NfeCabecMsg object, javax.xml.stream.XMLStreamReader reader) throws XMLStreamException {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_RECEPCAO_EVENTO, VERSAO_DADOS).equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue(XMLSCHEMA_INSTANCE, "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
    ...
    private org.apache.axiom.om.OMElement toOM(final RecepcaoEventoStub.NfeCabecMsgE param) {

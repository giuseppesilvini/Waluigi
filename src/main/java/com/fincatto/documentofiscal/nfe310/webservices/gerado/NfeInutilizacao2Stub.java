...
public class NfeInutilizacao2Stub extends org.apache.axis2.client.Stub {
    ...
    private void populateAxisService() {
        ...
        __operation.setName(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_INUTILIZACAO_2, NFE_INUTILIZACAO_NF_2));
    ...
    public NfeInutilizacao2Stub.NfeInutilizacaoNF2Result nfeInutilizacaoNF2(final NfeInutilizacao2Stub.NfeDadosMsg nfeDadosMsg, final NfeInutilizacao2Stub.NfeCabecMsgE nfeCabecMsg) throws java.rmi.RemoteException {
        ...
        try {
            ...
            env = this.toEnvelope(Stub.getFactory(_operationClient.getOptions().getSoapVersionURI()), nfeDadosMsg, new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeInutilizacao2", NFE_INUTILIZACAO_NF_2));
            env.build();
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), NfeInutilizacao2Stub.NfeInutilizacaoNF2Result.class);

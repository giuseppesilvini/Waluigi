...
public class NfeRetAutorizacaoStub extends org.apache.axis2.client.Stub {
    ...
    public NfeRetAutorizacaoStub.NfeRetAutorizacaoLoteResult nfeRetAutorizacaoLote(final NfeRetAutorizacaoStub.NfeDadosMsg nfeDadosMsg, final NfeRetAutorizacaoStub.NfeCabecMsgE nfeCabecMsg) throws java.rmi.RemoteException {
        ...
        try {
            ...
            env = this.toEnvelope(Stub.getFactory(operationClient.getOptions().getSoapVersionURI()), nfeDadosMsg, new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_RET_AUTORIZACAO, NFE_RET_AUTORICAO_LOTE));
            env.build();
    ...
    public static class NfeRetAutorizacaoLoteResult implements org.apache.axis2.databinding.ADBBean {
        ...
        public static class Factory {
            ...
            private static NfeRetAutorizacaoLoteResult fullTypeNameNotNull(String fullTypeName, javax.xml.stream.XMLStreamReader reader) throws Exception {
                if (fullTypeName != null) {
                    String nsPrefix = getNsPrefix(fullTypeName);
                    final java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":") + 1);

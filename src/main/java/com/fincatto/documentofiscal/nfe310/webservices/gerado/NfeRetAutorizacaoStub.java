...
public class NfeRetAutorizacaoStub extends org.apache.axis2.client.Stub {
    ...
    public NfeRetAutorizacaoStub.NfeRetAutorizacaoLoteResult nfeRetAutorizacaoLote(final NfeRetAutorizacaoStub.NfeDadosMsg nfeDadosMsg, final NfeRetAutorizacaoStub.NfeCabecMsgE nfeCabecMsg) throws java.rmi.RemoteException {
        ...
        try {
            ...
            env = this.toEnvelope(Stub.getFactory(operationClient.getOptions().getSoapVersionURI()), nfeDadosMsg, new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/nfe/wsdl/NfeRetAutorizacao", NFE_RET_AUTORICAO_LOTE));
            env.build();
    ...
    private org.apache.axiom.om.OMElement toOM(final NfeRetAutorizacaoStub.NfeCabecMsgE param) {
        return param.getOMElement(NfeRetAutorizacaoStub.NfeCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final NfeRetAutorizacaoStub.NfeDadosMsg param, final javax.xml.namespace.QName methodQName) {

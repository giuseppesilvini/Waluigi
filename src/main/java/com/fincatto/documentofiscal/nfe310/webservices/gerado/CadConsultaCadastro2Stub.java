...
public class CadConsultaCadastro2Stub extends org.apache.axis2.client.Stub {
    ...
    private void populateAxisService() {
        ...
        __operation.setName(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_CAD_CONSULTA_CADASTRO_2, CONSULTA_CADASTRO_2));
    ...
    public CadConsultaCadastro2Stub.ConsultaCadastro2Result consultaCadastro2(final CadConsultaCadastro2Stub.NfeDadosMsg nfeDadosMsg, final CadConsultaCadastro2Stub.NfeCabecMsgE nfeCabecMsg) throws java.rmi.RemoteException {
        ...
        try {
            ...
            env = this.toEnvelope(Stub.getFactory(_operationClient.getOptions().getSoapVersionURI()), nfeDadosMsg);
            env.build();
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), CadConsultaCadastro2Stub.ConsultaCadastro2Result.class);
    ...
    public static class NfeCabecMsg implements org.apache.axis2.databinding.ADBBean {
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
            ...
            if (this.localVersaoDadosTracker) {
                elementList.add(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_CAD_CONSULTA_CADASTRO_2, "versaoDados"));
                if (this.localVersaoDados != null) {
        ...
        public static class Factory {
            ...
            public static NfeCabecMsg parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
                ...
                try {
                    ...
                    if (reader.isStartElement() && new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_CAD_CONSULTA_CADASTRO_2, "versaoDados").equals(reader.getName())) {

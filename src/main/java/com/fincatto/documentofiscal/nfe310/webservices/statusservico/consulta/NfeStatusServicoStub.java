...
public class NfeStatusServicoStub extends org.apache.axis2.client.Stub {
    ...
    public com.fincatto.documentofiscal.nfe310.webservices.statusservico.consulta.NfeStatusServicoStub.NfeStatusServicoNFResult nfeStatusServicoNF(com.fincatto.documentofiscal.nfe310.webservices.statusservico.consulta.NfeStatusServicoStub.NfeDadosMsg nfeDadosMsg, com.fincatto.documentofiscal.nfe310.webservices.statusservico.consulta.NfeStatusServicoStub.NfeCabecMsgE nfeCabecMsg) throws java.rmi.RemoteException {
        ...
        try {
            ...
            env = toEnvelope(getFactory(_operationClient.getOptions().getSoapVersionURI()), nfeDadosMsg, optimizeContent(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_STATUS_SERVICO, "nfeStatusServicoNF")), new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_STATUS_SERVICO, "nfeDadosMsg"));
            env.build();
            // add the children only if the parameter is not null
            if (nfeCabecMsg != null) {
                org.apache.axiom.om.OMElement omElementnfeCabecMsg = toOM(nfeCabecMsg, optimizeContent(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_STATUS_SERVICO, "nfeStatusServicoNF")));
    ...
    private org.apache.axiom.om.OMElement toOM(com.fincatto.documentofiscal.nfe310.webservices.statusservico.consulta.NfeStatusServicoStub.NfeDadosMsg param, boolean optimizeContent) {
        //        try {
    ...
    private org.apache.axiom.om.OMElement toOM(com.fincatto.documentofiscal.nfe310.webservices.statusservico.consulta.NfeStatusServicoStub.NfeStatusServicoNFResult param, boolean optimizeContent) {
        //        try {
    ...
    private org.apache.axiom.om.OMElement toOM(com.fincatto.documentofiscal.nfe310.webservices.statusservico.consulta.NfeStatusServicoStub.NfeCabecMsgE param, boolean optimizeContent) {
        //        try {
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory, com.fincatto.documentofiscal.nfe310.webservices.statusservico.consulta.NfeStatusServicoStub.NfeDadosMsg param, boolean optimizeContent, javax.xml.namespace.QName elementQName) {
        //        try {
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter, boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (serializeType) {
                ...
                if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                    ...
                    writeAttribute("xsi", XMLSCHEMA_INSTANCE, "type", "nfeCabecMsg", xmlWriter);
                }
            }
            if (localExtraAttributes != null) {

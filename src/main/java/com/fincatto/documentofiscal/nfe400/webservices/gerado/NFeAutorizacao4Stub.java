...
public class NFeAutorizacao4Stub extends org.apache.axis2.client.Stub {
    ...
    public NfeResultMsg nfeAutorizacaoLote(final NfeDadosMsg nfeDadosMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4/nfeAutorizacaoLote");
            operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
            operationClient.getOptions().setProperty(HTTPConstants.CHUNKED, false);//INSERIDO PARA RESOLVER FALHA COM NFCe em MG
            ...
            env = this.toEnvelope(Stub.getFactory(operationClient.getOptions().getSoapVersionURI()), nfeDadosMsg1);
    ...
    public NfeResultMsg nfeAutorizacaoLoteZip(final NfeDadosMsgZip nfeDadosMsgZip3) throws java.rmi.RemoteException {
        ...
        try {
            ...
            operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4/nfeAutorizacaoLoteZip");
            operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
            this.addPropertyToOperationClient(operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
            // create a message context
            messageContext = MessageContextFactory.INSTANCE.create(config);
            // create SOAP envelope with that payload
            org.apache.axiom.soap.SOAPEnvelope env;
            env = this.toEnvelope(Stub.getFactory(operationClient.getOptions().getSoapVersionURI()), nfeDadosMsgZip3);
            // adding SOAP soap_headers
            this._serviceClient.addHeadersToEnvelope(env);
            // set the message context with that soap envelope
            messageContext.setEnvelope(env);
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final NfeDadosMsgZip param) {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
    ...
    public static class NfeResultMsg implements org.apache.axis2.databinding.ADBBean {
        ...
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_AUTORIZACAO_4, NFE_RESULT_MSG, "ns1");
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (serializeType) {
                final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_AUTORIZACAO_4);
        ...
        private static java.lang.String generatePrefix(final java.lang.String namespace) {
            if (namespace.equals(HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_AUTORIZACAO_4)) {
                return "ns1";
            }
    ...
    public static class NfeDadosMsg implements org.apache.axis2.databinding.ADBBean {
        ...
        public static class Factory {
            ...
            private static NfeDadosMsg parsePart1(javax.xml.stream.XMLStreamReader reader) throws ADBException {
                if (reader.getAttributeValue(HTTP_WWW_W3_ORG_2001_XML_SCHEMA_INSTANCE, "type") != null) {
                    final java.lang.String fullTypeName = reader.getAttributeValue(HTTP_WWW_W3_ORG_2001_XML_SCHEMA_INSTANCE, "type");
                    if (fullTypeName != null) {
                        java.lang.String nsPrefix = null;
    ...
    public static class NfeDadosMsgZip implements org.apache.axis2.databinding.ADBBean {
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (serializeType) {
                final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, HTTP_WWW_PORTALFISCAL_INF_BR_NFE_WSDL_NFE_AUTORIZACAO_4);
                if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                    this.writeAttribute("xsi", HTTP_WWW_W3_ORG_2001_XML_SCHEMA_INSTANCE, "type", namespacePrefix + ":nfeDadosMsgZip", xmlWriter);
                } else {
                    this.writeAttribute("xsi", HTTP_WWW_W3_ORG_2001_XML_SCHEMA_INSTANCE, "type", NFE_DADOS_MSG_ZIP, xmlWriter);
                }
            }

...
public class NFGeraHashCSRT {
    ...
    public static String base64EncodeToString(String toEncode) throws NoSuchAlgorithmException {
        return Base64.getEncoder().encodeToString(getSha256(toEncode));
    }

    public static byte[] getSha256(String toEncode) throws NoSuchAlgorithmException {
        return MessageDigest.
                getInstance("SHA-256").digest(toEncode.getBytes());
    }

    public static String getStringSha256(String toEncode) throws NoSuchAlgorithmException {
        return String.format("%040x", new BigInteger(1, NFGeraHashCSRT.getSha256(toEncode)));
    }

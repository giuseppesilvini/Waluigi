...
public class DFAssinaturaDigital implements DFLog {
    ...
    public boolean isValida(final InputStream xmlStream) throws SAXException, MarshalException, ParserConfigurationException, IOException, ClassNotFoundException, NoSuchMethodException, XMLSignatureException, InvocationTargetException, InstantiationException, IllegalAccessException {

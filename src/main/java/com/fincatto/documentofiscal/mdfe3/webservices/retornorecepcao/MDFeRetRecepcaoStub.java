...
public class MDFeRetRecepcaoStub extends org.apache.axis2.client.Stub {
    ...
    public com.fincatto.documentofiscal.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub.MdfeRetRecepcaoResult mdfeRetRecepcao(final com.fincatto.documentofiscal.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub.MdfeDadosMsg mdfeDadosMsg0, final com.fincatto.documentofiscal.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            env = this.toEnvelope(Stub.getFactory(_operationClient.getOptions().getSoapVersionURI()), mdfeDadosMsg0, this.optimizeContent(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_RET_RECEPCAO, "mdfeRetRecepcao")), new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_RET_RECEPCAO, "mdfeRetRecepcao"));
            env.build();
            // add the children only if the parameter is not null
            if (mdfeCabecMsg1 != null) {
                final org.apache.axiom.om.OMElement omElementmdfeCabecMsg1 = this.toOM(mdfeCabecMsg1, this.optimizeContent(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_RET_RECEPCAO, "mdfeRetRecepcao")));
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (serializeType) {
                ...
                if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                    ...
                    this.writeAttribute("xsi", XMLSCHEMA_INSTANCE, "type", "mdfeCabecMsg", xmlWriter);
                }
            }
            if (this.localExtraAttributes != null) {
    ...
    public static class ExtensionMapper {
        ...
        public static java.lang.Object getTypeObject(final java.lang.String namespaceURI, final java.lang.String typeName, final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            if (HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_RET_RECEPCAO.equals(namespaceURI) && "mdfeCabecMsg".equals(typeName)) {
    ...
    public static class MdfeCabecMsgE implements org.apache.axis2.databinding.ADBBean {
        ...
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_RET_RECEPCAO, "mdfeCabecMsg", "ns4");

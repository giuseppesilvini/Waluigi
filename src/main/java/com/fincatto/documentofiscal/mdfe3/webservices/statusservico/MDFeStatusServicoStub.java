...
public class MDFeStatusServicoStub extends org.apache.axis2.client.Stub {
    ...
    private void populateAxisService() {
        ...
        operation.setName(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO, "mdfeStatusServicoMDF"));
        ...
        org.apache.axis2.client.async.AxisCallback returnCallback = new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onError(final java.lang.Exception error) {
                if (error instanceof org.apache.axis2.AxisFault) {
                    ...
                    final org.apache.axiom.om.OMElement faultElt = f.getDetail();
                    if (faultElt != null &&
                                MDFeStatusServicoStub.this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), "mdfeStatusServicoMDF"))) {
                        // make the fault by reflection
                        try {

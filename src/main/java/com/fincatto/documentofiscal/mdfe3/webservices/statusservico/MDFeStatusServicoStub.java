...
public class MDFeStatusServicoStub extends org.apache.axis2.client.Stub {
    ...
    public static final String HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO = "http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeStatusServico";
    ...
    private void populateAxisService() {
        ...
        operation.setName(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO, MDFE_STATUS_SERVICO_MDF));
    ...
    public com.fincatto.documentofiscal.mdfe3.webservices.statusservico.MDFeStatusServicoStub.MdfeStatusServicoMDFResult mdfeStatusServicoMDF(final com.fincatto.documentofiscal.mdfe3.webservices.statusservico.MDFeStatusServicoStub.MdfeDadosMsg mdfeDadosMsg0, final com.fincatto.documentofiscal.mdfe3.webservices.statusservico.MDFeStatusServicoStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeStatusServico/mdfeStatusServicoMDF");
            ...
            final java.lang.Object object = this.fromOM(returnEnv.getBody().getFirstElement(), com.fincatto.documentofiscal.mdfe3.webservices.statusservico.MDFeStatusServicoStub.MdfeStatusServicoMDFResult.class);
            ...
            if (!this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), MDFE_STATUS_SERVICO_MDF))) {
                throw f;
            }
            // make the fault by reflection
            try {
                final java.lang.String exceptionClassName = (java.lang.String) this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), MDFE_STATUS_SERVICO_MDF));
                ...
                // message class
                final java.lang.String messageClassName = (java.lang.String) this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), MDFE_STATUS_SERVICO_MDF));
    ...
    public void startmdfeStatusServicoMDF(final com.fincatto.documentofiscal.mdfe3.webservices.statusservico.MDFeStatusServicoStub.MdfeDadosMsg mdfeDadosMsg0, final com.fincatto.documentofiscal.mdfe3.webservices.statusservico.MDFeStatusServicoStub.MdfeCabecMsgE mdfeCabecMsg1, final com.fincatto.documentofiscal.mdfe3.webservices.statusservico.MDFeStatusServicoCallbackHandler callback) throws java.rmi.RemoteException {
        ...
        operationClient.addMessageContext(messageContext);
        operationClient.setCallback(createeCallback(callback, messageContext));
    ...
    private org.apache.axis2.client.async.AxisCallback createeCallback(com.fincatto.documentofiscal.mdfe3.webservices.statusservico.MDFeStatusServicoCallbackHandler callback, org.apache.axis2.context.MessageContext messageContext) {
        return new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = MDFeStatusServicoStub.this.fromOM(resultEnv.getBody().getFirstElement(), com.fincatto.documentofiscal.mdfe3.webservices.statusservico.MDFeStatusServicoStub.MdfeStatusServicoMDFResult.class);
    ...
    @SuppressWarnings({"rawtypes", "unchecked"})
    private void callbackError(java.lang.Exception error, com.fincatto.documentofiscal.mdfe3.webservices.statusservico.MDFeStatusServicoCallbackHandler callback) {
        if (error instanceof org.apache.axis2.AxisFault) {
            final org.apache.axis2.AxisFault f = (org.apache.axis2.AxisFault) error;
            final org.apache.axiom.om.OMElement faultElt = f.getDetail();
            if (faultElt != null &&
                        MDFeStatusServicoStub.this.faultExceptionNameMap.containsKey(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), MDFE_STATUS_SERVICO_MDF))) {
                // make the fault by reflection
                try {
                    final java.lang.String exceptionClassName = (java.lang.String) MDFeStatusServicoStub.this.faultExceptionClassNameMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), MDFE_STATUS_SERVICO_MDF));
                    final java.lang.Class exceptionClass = java.lang.Class.forName(exceptionClassName);
                    final java.lang.reflect.Constructor constructor = exceptionClass.getConstructor(String.class);
                    final java.lang.Exception ex = (java.lang.Exception) constructor.newInstance(f.getMessage());
                    // message class
                    final java.lang.String messageClassName = (java.lang.String) MDFeStatusServicoStub.this.faultMessageMap.get(new org.apache.axis2.client.FaultMapKey(faultElt.getQName(), MDFE_STATUS_SERVICO_MDF));
                    final java.lang.Class messageClass = java.lang.Class.forName(messageClassName);
                    final java.lang.Object messageObject = MDFeStatusServicoStub.this.fromOM(faultElt, messageClass);
                    final java.lang.reflect.Method m = exceptionClass.getMethod("setFaultMessage", messageClass);
                    m.invoke(ex, messageObject);
    ...
    public static class MdfeCabecMsgE implements org.apache.axis2.databinding.ADBBean {
        ...
        private static java.lang.String generatePrefix(final java.lang.String namespace) {
            if (namespace.equals(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO)) {
                return "ns5";
            }
    ...
    public static class MdfeDadosMsg implements org.apache.axis2.databinding.ADBBean {
        ...
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO, MDFE_DADOS_MSG, "ns5");
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (serializeType) {
                final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO);
    ...
    public static class MdfeStatusServicoMDFResult implements org.apache.axis2.databinding.ADBBean {
        ...
        public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO, MDFE_STATUS_SERVICO_MDF_RESULT, "ns5");
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (serializeType) {
                final java.lang.String namespacePrefix = this.registerPrefix(xmlWriter, HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO);
                if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
                    this.writeAttribute("xsi", XMLSCHEMA_INSTANCE, "type", namespacePrefix + ":mdfeStatusServicoMDFResult", xmlWriter);
                } else {
                    this.writeAttribute("xsi", XMLSCHEMA_INSTANCE, "type", MDFE_STATUS_SERVICO_MDF_RESULT, xmlWriter);
                }
            }
            if (this.localExtraElement != null) {
                this.localExtraElement.serialize(xmlWriter);
        ...
        public static class Factory {
            ...
            public static MdfeStatusServicoMDFResult parse(final javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
                ...
                try {
                    ...
                    MdfeStatusServicoMDFResult varParse = parsePart1(reader);
                    if(varParse != null) {
                        return varParse;
                    }
                    // Note all attributes that were handled. Used to differ normal attributes
            ...
            static private MdfeStatusServicoMDFResult parsePart1(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
                if (reader.getAttributeValue(XMLSCHEMA_INSTANCE, "type") != null) {
                    ...
                    if (fullTypeName != null) {
                        ...
                        nsPrefix = nsPrefix == null ? "" : nsPrefix;
                        final java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":") + 1);
                        if (!MDFE_STATUS_SERVICO_MDF_RESULT.equals(type)) {
                            // find namespace for the prefix
                            final java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
    ...
    public static class MdfeCabecMsg implements org.apache.axis2.databinding.ADBBean {
        ...
        public void serialize(final javax.xml.namespace.QName parentQName, final javax.xml.stream.XMLStreamWriter xmlWriter, final boolean serializeType) throws javax.xml.stream.XMLStreamException {
            ...
            if (this.localCUFTracker) {
                namespace = HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO;
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(final javax.xml.namespace.QName qName) throws org.apache.axis2.databinding.ADBException {
            ...
            final java.util.ArrayList attribList = new java.util.ArrayList();
            if (this.localCUFTracker) {
                elementList.add(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO, "cUF"));
                if (this.localCUF != null) {
            ...
            if (this.localVersaoDadosTracker) {
                elementList.add(new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO, VERSAO_DADOS));
                if (this.localVersaoDados != null) {
        ...
        public static class Factory {
            ...
            private static MdfeCabecMsg parsePart2 (MdfeCabecMsg object, javax.xml.stream.XMLStreamReader reader) throws XMLStreamException {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO, "cUF").equals(reader.getName())) {
            ...
            private static MdfeCabecMsg parsePart3 (MdfeCabecMsg object, javax.xml.stream.XMLStreamReader reader) throws XMLStreamException {
                ...
                if (reader.isStartElement() && new javax.xml.namespace.QName(HTTP_WWW_PORTALFISCAL_INF_BR_MDFE_WSDL_MDFE_STATUS_SERVICO, VERSAO_DADOS).equals(reader.getName())) {
                    nillableValue = reader.getAttributeValue(XMLSCHEMA_INSTANCE, "nil");
                    if ("true".equals(nillableValue) || "1".equals(nillableValue)) {
    ...
    private org.apache.axiom.om.OMElement toOM(final com.fincatto.documentofiscal.mdfe3.webservices.statusservico.MDFeStatusServicoStub.MdfeCabecMsgE param) {
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final com.fincatto.documentofiscal.mdfe3.webservices.statusservico.MDFeStatusServicoStub.MdfeDadosMsg param) {

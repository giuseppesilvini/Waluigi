...
import com.fincatto.documentofiscal.nfe310.classes.nota.NFNotaInfoItemImpostoICMS40;
...
public class NFNotaInfoItemImpostoICMS40Test {
    ...
    public void devePermitirValorICMSDesoneracaoNulo() {
        ...
        assertEquals(new BigDecimal("99999999999.99"),new BigDecimal(icms40.getValorICMSDesoneracao()));
        icms40.toString();
    }

...
public class DFPaisTest {
    ...
    public void deveRetornarPorCodigo() {
         ...
         Assert.assertEquals(DFPais.valueOfCodigo(1830), DFPais.COOK_ILHAS);
         Assert.assertEquals(DFPais.valueOfCodigo("1872"), DFPais.COREIA_DO_NORTE_REP_POP_DEMOCRATICA);
         Assert.assertEquals(DFPais.valueOfCodigo(1872), DFPais.COREIA_DO_NORTE_REP_POP_DEMOCRATICA);
         Assert.assertEquals(DFPais.valueOfCodigo("1902"), DFPais.COREIA_DO_SUL_REPUBLICA_DA);
         Assert.assertEquals(DFPais.valueOfCodigo(1902), DFPais.COREIA_DO_SUL_REPUBLICA_DA);
